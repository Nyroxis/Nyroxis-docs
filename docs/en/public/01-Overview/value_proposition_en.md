...
Most security tools fall into two extremes:
- **Too simple** (consumer antivirus) → signature-based, reactive, no forensics, no correlation
- **Too complex** (corporate SIEM/SOC) → heavy, expensive, cloud-dependent, not designed for personal use

Nyroxis is designed specifically for the middle ground:
- Lightweight and silent
- Privacy-first and offline-capable
- Multi-layer detection — not just signatures
- Forensic-grade evidence preservation
- Extensible by security professionals
- Human-friendly for non-technical users

## Core Benefits

### ✔ Multi-Layer Detection
27 detection rules, 12 correlation rules, 2 chain rules — covering individual events, event relationships, and multi-stage attacks.
...
Security professionals get forensic search, rule customization, correlation analysis, and AI-driven anomaly review.

## The Promise of Nyroxis

**Security that protects people, not just systems.**

Nyroxis transforms the most overlooked vulnerability in modern cybersecurity — the personal device of a high-value individual — into a controlled, monitored, and forensically ready security asset.
